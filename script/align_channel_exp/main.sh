    ...
    do  
        ...
        do
            ...
            gnome-terminal --wait -- /bin/bash  \
                ...
                echo python train.py --task ${tasks[${i}]} --n_demos ${n_demo} --n_rotations ${n_rotations[${i}]} \
            ...
            gnome-terminal --wait -- /bin/bash  \
                ...
                echo python gripper_test.py --task ${tasks[${i}]} --n_demos ${n_demo} --n_rotations ${n_rotations[${i}]} \
