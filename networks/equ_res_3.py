...
class EquResUNet(torch.nn.Module):
    def __init__(self, n_input_channel=1, n_output_channel=16, n_middle_channels=(16, 32, 64, 128), kernel_size=3, N=6, flip=False, quotient=False, initialize=False):
        super().__init__()
        self.N = N
...
class dian_res(torch.nn.Module):
    def __init__(self,in_dim,out_dim,N=6,middle_dim=(32, 64, 128, 256),init=False):
