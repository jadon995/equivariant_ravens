...
def get_gaussian_3d_label(map_size, center, radius, 
    ...
    angle_label = get_angle_smooth_label(center[0], angle_range=360, radius=radius, normalized=True)
    ...
    heatmap_3d = heatmap_3d.reshape(*map_size)

    return heatmap_3d

if __name__ == '__main__':
    heatmap_3d = get_gaussian_3d_label((180, 10, 10), (90, 4, 4), radius=1, device='cuda')
