...
__all__ = ["QIFTPointwise", "QuotientFourierELU"]
...
class QIFTPointwise(EquivariantModule):
    ...
    def __init__(self,
        ...
        super(QIFTPointwise, self).__init__()
        ...
        self.out_space = outspace
        self.out_type = FieldType(self.out_space, out_channels * [self.out_space.quotient_repr(2)])
...
# class QuotientFourierELU(QIFTPointwise):
...
#         coefficients. See :class:`~escnn.nn.QIFTPointwise` for more details.
