...
class FourierGroupAvgPool(EquivariantModule):
    ...
    def __init__(
        ...
        super(FourierGroupAvgPool, self).__init__()
    ...
    def forward(self, input: GeometricTensor) -> GeometricTensor:
        ...
        # avoid the non linear transformation
        # y = self._function(x)

        y_hat = torch.einsum('bcg...,fg->bcf...', x, self.Ainv)
